...
if(isset($_POST['update']))
{
	...
	for($i=1; $i<=$no; $i++)
	{
		$name=$_POST["$i"];
		if($_POST["$i"])
			mysql_query("UPDATE company SET name='$name' WHERE id='$i'");
	}
...
.cell {font-weight: bold; color: #0099FF; }
.style8 {color: #000099}
-->
</style>
        ...
        <tr>
          <td align="center" bgcolor="#FFFFFF">
              ...
              <table width="479" height="60" border="0" align="center" bordercolor="#FFFFFF">
                ...
                <tr bgcolor="#0066FF">
                  <td width="73" height="27"><div align="right" class="adddept3 style3 princprof3 style1">
                      <div align="left" class="style8">
                        <div align="center" class="style9">S/No</div>
                      </div>
                  </div></td>
                  <td width="396"><div align="center"><span class="style7">Name</span></div></td>
                </tr>
                <?php 
				$con = mysql_connect("localhost","root","");
					if (!$con)
					...
					while($row = mysql_fetch_array($result))
 					 {
						 ...
						 echo "<tr class=\"cell\">
                  			...
                  			<td align=\"left\"><input type=\"text\" name=\"$id\" value=\"$name\" size=\"50\" class=\"cell\"></td>                  			
                			</tr>"; 
						if($color==0)
							$color=$color+1;
						else
                ...
                <p align="center">
                  <input name="update" type="submit" class="butstyle" id="update" value="Update">
                </p>
            </form>
          </td>
        </tr>
