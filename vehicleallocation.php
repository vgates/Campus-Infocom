  ...
  <tr>
    ...
    <td width="70%" align="left" valign="top">
      ...
      <table width="400" border="0" align="left" cellpadding="1" cellspacing="1" bgcolor="#0099FF">
        <tr>
          <td align="center" bgcolor="#FFFFFF"><form name="form1" method="post" action="vehicleallocation_list.php" onSubmit="return validate_form(this)">
            <div align="center" class="adddept1"></div>
            <table width="400" height="108" border="0" align="center" bordercolor="#FFFFFF">
              <tr>
                <td height="27" colspan="3" background="title.jpg"><div align="center"><span class="style5">:: VEHICLE ALLOCATION:: </span></div></td>
              </tr>
              <tr>
...
?>
              ...
              <tr>
                <td height="27"><div align="left"><span class="style1 princprof3">Semester</span></div></td>
                <td><span class="style1 princprof3">:</span></td>
                <td><div align="left"><span class="style1 princprof3">
