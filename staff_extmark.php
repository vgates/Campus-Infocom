...
$int12=$_POST['int15']; $ext12=$_POST['ext15']; $sub12=$_POST['sub15'];
	...
	mysql_close($con);
	header('Location: edit_extmarks.php');
}
}
...
$int12=$_POST['int14']; $ext12=$_POST['ext14']; $sub12=$_POST['sub14'];
$int12=$_POST['int15']; $ext12=$_POST['ext15']; $sub12=$_POST['sub15'];
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub1'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int1 WHERE studid='$studid' AND subid='$sub1'");			
		mysql_query("UPDATE extmark_app SET external=$ext1 WHERE studid='$studid' AND subid='$sub1'");
	}
	else
	{		
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub1','$int1','$ext1')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub2'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int2 WHERE studid='$studid' AND subid='$sub2'");			
		mysql_query("UPDATE extmark_app SET external=$ext2 WHERE studid='$studid' AND subid='$sub2'");
	}
	else
	{		
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub2','$int2','$ext2')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub3'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int3 WHERE studid='$studid' AND subid='$sub3'");			
		mysql_query("UPDATE extmark_app SET external=$ext3 WHERE studid='$studid' AND subid='$sub3'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub3','$int3','$ext3')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub4'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int4 WHERE studid='$studid' AND subid='$sub4'");			
		mysql_query("UPDATE extmark_app SET external=$ext4 WHERE studid='$studid' AND subid='$sub4'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub4','$int4','$ext4')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub5'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int5 WHERE studid='$studid' AND subid='$sub5'");			
		mysql_query("UPDATE extmark_app SET external=$ext5 WHERE studid='$studid' AND subid='$sub5'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub5','$int5','$ext5')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub6'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int6 WHERE studid='$studid' AND subid='$sub6'");			
		mysql_query("UPDATE extmark_app SET external=$ext6 WHERE studid='$studid' AND subid='$sub6'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub6','$int6','$ext6')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub7'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int7 WHERE studid='$studid' AND subid='$sub7'");			
		mysql_query("UPDATE extmark_app SET external=$ext7 WHERE studid='$studid' AND subid='$sub7'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub7','$int7','$ext7')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub8'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int8 WHERE studid='$studid' AND subid='$sub8'");			
		mysql_query("UPDATE extmark_app SET external=$ext8 WHERE studid='$studid' AND subid='$sub8'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub8','$int8','$ext8')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub9'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int9 WHERE studid='$studid' AND subid='$sub9'");			
		mysql_query("UPDATE extmark_app SET external=$ext9 WHERE studid='$studid' AND subid='$sub9'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub9','$int9','$ext9')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub10'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int10 WHERE studid='$studid' AND subid='$sub10'");			
		mysql_query("UPDATE extmark_app SET external=$ext10 WHERE studid='$studid' AND subid='$sub10'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub10','$int10','$ext10')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub11'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int11 WHERE studid='$studid' AND subid='$sub11'");			
		mysql_query("UPDATE extmark_app SET external=$ext11 WHERE studid='$studid' AND subid='$sub11'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub11','$int11','$ext11')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub12'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int12 WHERE studid='$studid' AND subid='$sub12'");			
		mysql_query("UPDATE extmark_app SET external=$ext12 WHERE studid='$studid' AND subid='$sub12'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub12','$int12','$ext12')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub13'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int13 WHERE studid='$studid' AND subid='$sub13'");			
		mysql_query("UPDATE extmark_app SET external=$ext13 WHERE studid='$studid' AND subid='$sub13'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub13','$int13','$ext13')");
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub14'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int14 WHERE studid='$studid' AND subid='$sub14'");			
		mysql_query("UPDATE extmark_app SET external=$ext14 WHERE studid='$studid' AND subid='$sub14'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub14','$int14','$ext14')");
	}
	$query=mysql_query("SELECT * from extmark_app WHERE studid='$studid' AND subid='$sub15'");	
	$row=mysql_fetch_array($query);
	if($row)
	{
		mysql_query("UPDATE extmark_app SET internal=$int15 WHERE studid='$studid' AND subid='$sub15'");			
		mysql_query("UPDATE extmark_app SET external=$ext15 WHERE studid='$studid' AND subid='$sub15'");
	}
	else
	{
		mysql_query("INSERT INTO extmark_app (studid,subid,internal,external) VALUES ('$studid','$sub15','$int15','$ext15')");
	}
	}
	mysql_close($con);
	header('Location: edit_extmarks.php');
...
<body>
   ...
   <table width="980" border="0" align="center">
     <tr>
       ...
       <td width="69%" valign="top"><form name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
         <table width="200" border="0" cellpadding="1" cellspacing="1" bgcolor="#0099FF">
           <tr>
             <td bgcolor="#FFFFFF"><table width="200" border="0" align="center">
                 <tr>
                   <td height="21" colspan="2" nowrap background="title.jpg"><div align="center"><span class="style1 style2"><strong>:: External Performance of <strong><?php echo $name; ?> :: </strong></strong></span></div></td>
                 </tr>
                 <tr>
                   <td height="35" nowrap><div align="right" class="style1">Select semester to generate external marks:</div></td>
                   <td><select name="sem" class="box" id="sem" onChange="return submitForm('sem')">
...
while($row = mysql_fetch_array($result))
{
		...
		$sub="sub".$i;
		$x=$row['subid'];
		$intmark_query= mysql_query("SELECT * FROM extmark WHERE studid='$studid' AND subid='$x'");
		$intmark_array=mysql_fetch_array($intmark_query);
		if($intmark_array)
		{
			$intmark=$intmark_array['internal'];
			$extmark=$intmark_array['external'];
		}
		else
		{
			$extmark=NULL;
...
?>
                 ...
                 <p align="center">
                   <?php
  if(!empty($_POST['sem'])){  
   echo " <input type=\"submit\" name=\"Submit\" class=\"butstyle\" value=\"Save Temporarily\">
    <input type=\"submit\" name=\"Submit2\" value=\"Click To Approve\" class=\"butstyle\">";
	}
	?>
               </p></td>
           </tr>
