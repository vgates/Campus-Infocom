...
<table width="980" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td width="245" valign="top"><span class="princprof3"><img src="<?php echo $src; ?>" alt="" name="photo" width="137" height="169" border="2" class="style6"></span></td>
    <td width="728" valign="top"><form name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
      <div align="center"></div>
      <div align="center"></div>
        <table width="200" border="0" cellspacing="1" cellpadding="1">
        <tr>
          <td><p align="center"><img src="tt.jpg" width="215" height="60"></p>
            <table width="517" border="0" align="center" bordercolor="#00CCFF" bgcolor="#00CCFF" frame="box">
              <tr bgcolor="#FFFFFF">
