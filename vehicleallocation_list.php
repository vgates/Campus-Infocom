...
function validate_form(thisform)
{
	with(thisform)
	{
		...
		if (validate_required(vehicle,"Select vehicle..!")==false)
		{
			vehicle.focus();
			return false;
		}
...
<table width="980" border="0" align="center">
  ...
  <tr>
    <td valign="top"><form name="form1" method="post" action="vehicleallocation_confirm.php" onSubmit="return validate_form(this)">
      <table width="283" border="0" align="center">
        <tr>
          <td width="132" nowrap><span class="style6">Bus Number :</span></td>
          <td width="141"><span class="style6">
            <select name="vehicle" class="box" id="select3">
              ...
              <?php 
				$con = mysql_connect("localhost","root","");
					...
					$result = mysql_query("SELECT * FROM transport_set");
