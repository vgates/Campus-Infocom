	...
	$maxchem=$_POST['maxchem'];
		...
		{ 
			...
			mysql_close();				
				...
				echo "document.location.href=\"stud_entry.php\";";
				echo "</script>";
...
.studet13 {color: #00CC33; font-size: 14px; }
            ...
            <tr>
              <td bgcolor="#FFFFFF">
                <table width="410" border="0" align="center" cellspacing="0">
                  <tr>
                    <th height="28" colspan="3" scope="row" background="title.jpg"><span class="studet2 studet14 studet12"><span class="studet2  studet14 studet1"><span class="studet2  studet14 style2"><span class="studet14 studet12 style4"><strong>:: STUDENT DETAILS ::</strong></span></span></span></span></th>
                  </tr>
                  <tr>
                    ...
                    <td width="229"><div align="left" class="studet14">
                        <div align="left"><span class="studet1">DD</span>
                            <input name="date" type="text" class="box" id="date4" value="<?php echo $date; ?>" size="2">
                            <span class="studet1">MM
                            <input name="month" type="text" class="box" id="month4" value="<?php echo $month; ?>" size="2">
                        YYYY
                        <input name="year" type="text" class="box" id="year4" value="<?php echo $year; ?>" size="4">
                          </span></div>
                    </div></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <th height="72" scope="row" valign="top"><div align="right" class="studet15">
                        <div align="left"><p>Temporary Address</p></div>
                    </div></th>
                    <td valign="top"><span class="studet14"><strong>:</strong></span></td>
                    <td valign="top"><div align="left" class="studet14">
...
?>
                ...
                <table width="410" border="0" align="center" cellspacing="0">
                  <tr bgcolor="#0099FF">
                    <th height="19" colspan="3" class="studet12" scope="row"><span class="studet14 style4"><strong>:: Guardian Details :: </strong></span></th>
                  </tr>
                  <tr>
          ...
          <tr>
            <td bgcolor="#FFFFFF">
              <table width="410" border="0" align="center">
                <tr>
                  <th height="28" colspan="3" scope="row" background="title.jpg"><span class="studet2 studet14 studet12"><span class="studet2  studet14 studet1"><span class="studet2  studet14 style2"><span class="studet14 studet12 style4"><strong>:: ACADEMIC DETAILS ::</strong></span></span></span></span></th>
                </tr>
                <tr bgcolor="#0099FF">
                ...
                <tr>
                  ...
                  <td width="229"><div align="left" class="studet14">
                      <div align="left">
                        <input name="xinst" type="text" id="xinst" value="<?php echo $xinst; ?>" size="37">
</div>
                  </div></td>
                </tr>
                <tr>
                  ...
                  <td><div align="left" class="studet14">
                      <div align="left">
                        <input name="xboard" type="text" id="xboard2" value="<?php echo $xboard; ?>">
                      </div>
                  </div></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><span class="studet14"><strong>:</strong></span></td>
                  <td><div align="left"><span class="studet14">
                      <input name="xmaxmarks" type="text" id="xmaxmarks2" value="<?php echo $xmaxmarks; ?>">
                  </span></div></td>
                </tr>
                <tr>
                  <th height="24" scope="row"><div align="right" class="studet14">
                  ...
                  <td><div align="left"><span class="studet14"> Obt. Marks
                            <input name="maths" type="text" id="maths4" size="3">&nbsp;
                    Max Marks
                    <input name="maxmaths" type="text" id="maxmaths4" size="3">
                  </span></div></td>
                </tr>
                <tr>
                  ...
                  <td><span class="studet14"><strong>:</strong></span></td>
                  <td><div align="left"><span class="studet14">Obt. Marks
                            <input name="phy" type="text" id="phy2" size="3">&nbsp;
                    Max Marks
                    <input name="maxphy" type="text" id="maxphy2" size="3">
                  </span></div></td>
                </tr>
                <tr>
                  ...
                  <td><span class="studet14">Obt. Marks
                        <input name="chem" type="text" id="chem" size="3">&nbsp;
                  Max Marks
                  <input name="maxchem" type="text" id="maxchem" size="3">
                  </span></td>
                </tr>
                <tr>
              ...
              <table width="410" border="0" align="center">
                <tr bgcolor="#0099FF">
                  <th height="28" colspan="3" class="studet12" scope="row"><span class="studet14 style4"><strong>:: 10th DETAILS :: </strong></span></th>
                </tr>
                <tr>
                  ...
                  <td width="203"><div align="left" class="studet14">
                      <div align="left">
                        <input name="xiiinst" type="text" id="xiiinst" value="<?php echo $xiiinst; ?>" size="37">
                      </div>
                  </div></td>
                </tr>
                <tr>
                  ...
                  <td><div align="left" class="studet14">
                      <div align="left">
                        <input name="xiiboard" type="text" id="xiiboard" value="<?php echo $xiiboard; ?>">
                      </div>
                  </div></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><span class="studet14"><strong>:</strong></span></td>
                  <td><div align="left"><span class="studet14">
                      <input name="xiimaxmarks" type="text" id="xmaxmarks2" value="<?php echo $xiimaxmarks; ?>">
                  </span></div></td>
                </tr>
              </table>            </td>
          </tr>
  ...
  <p align="center">
    ...
    <input name="Submit" type="submit" class="butstyle" tabindex="0" value="Submit">
